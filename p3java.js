...
function funFact(){
var funFact = ["My favorite composer is Chopin",
"I made this website with my first programing class",
"I composed my first piano peice only a few months ago"];
var math= Math.floor(Math.random()*funFact.length);
document.getElementById("fun").innerHTML= funFact[math];
}
